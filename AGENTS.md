...
- The runtime is centred on `server.py`.
...
- Treat manifests as declared interface, not proof of behaviour.
...
- Keep auth-mode behaviour explicit: OAuth, API key, and Keep master token are the active support stories.
